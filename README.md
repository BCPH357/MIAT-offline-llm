...
**3. 内网调用（替换为实际服务器 IP）**
```bash
curl http://192.168.1.100:11436/api/generate -d '{
  "model": "gpt-oss:20b",
...
- 使用浏览器访问: `http://192.168.1.100:11436/api/tags`
...
fetch(`http://${SERVER_IP}:11436/api/generate`, {
  method: 'POST',
  headers: {
